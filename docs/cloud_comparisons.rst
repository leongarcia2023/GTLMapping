...
2. **Foreground change** shows the moderate spatial foreground minus the BT12
   constant. Red areas raise the foreground relative to BT12 and blue areas
   lower it.
...
sums increase by 3.91%, 9.26%, and 9.74%. Moderate GTL contains 77 censored
...
16.61%. Moderate GTL contains 9 censored lower limits; liberal GTL contains
81.
...
2.26%, 8.38%, and 25.56%. Moderate GTL contains 26 censored lower limits;
...
.. list-table:: Change in summed nonnegative surface density relative to BT12
   ...
   * - Conservative
     ...
     - +2.26%
   * - Moderate
     - +9.26% (77 lower limits)
     - +9.89% (9 lower limits)
     - +8.38% (26 lower limits)
   * - Liberal
     - +9.74% (762 lower limits)
     - +16.61% (81 lower limits)
